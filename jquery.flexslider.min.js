        ...
        a.data(b, "flexslider", d), n = {
            ...
            controlNav: {
                ...
                setupPaging: function() {
                    var i, b = "thumbnails" === e.controlNav ? "control-thumbs" : "control-paging",
                        c = 1;
                    if (d.controlNavScaffold = a('<ol class="' + f + "control-nav " + f + b + '"></ol>'), d.pagingCount > 1)
                        for (var j = 0; j < d.pagingCount; j++) i = "thumbnails" === e.controlNav ? '<img src="' + d.slides.eq(j).attr("data-thumb") + '"/>' : "<a>" + c + "</a>", d.controlNavScaffold.append("<li>" + i + "</li>"), c++;
            ...
            touch: function() {
                function o(h) {
                    d.animating ? h.preventDefault() : 1 === h.touches.length && (d.pause(), g = i ? d.h : d.w, m = Number(new Date), f = k && j && d.animatingTo === d.last ? 0 : k && j ? d.limit - (d.itemW + e.itemMargin) * d.move * d.animatingTo : k && d.currentSlide === d.last ? d.limit : k ? (d.itemW + e.itemMargin) * d.move * d.currentSlide : j ? (d.last - d.currentSlide + d.cloneOffset) * g : (d.currentSlide + d.cloneOffset) * g, a = i ? h.touches[0].pageY : h.touches[0].pageX, c = i ? h.touches[0].pageX : h.touches[0].pageY, b.addEventListener("touchmove", p, !1), b.addEventListener("touchend", q, !1))
                }

                function p(b) {
                    h = i ? a - b.touches[0].pageY : a - b.touches[0].pageX, n = i ? Math.abs(h) < Math.abs(b.touches[0].pageX - c) : Math.abs(h) < Math.abs(b.touches[0].pageY - c), (!n || Number(new Date) - m > 500) && (b.preventDefault(), !l && d.transitions && (e.animationLoop || (h /= 0 === d.currentSlide && h < 0 || d.currentSlide === d.last && h > 0 ? Math.abs(h) / g + 2 : 1), d.setProps(f + h, "setTouch")))
                }

                function q(i) {
                    if (b.removeEventListener("touchmove", p, !1), d.animatingTo === d.currentSlide && !n && null !== h) {
                        var k = j ? -h : h,
                            o = k > 0 ? d.getTarget("next") : d.getTarget("prev");
                        d.canAdvance(o) && (Number(new Date) - m < 550 && Math.abs(k) > 50 || Math.abs(k) > g / 2) ? d.flexAnimate(o, e.pauseOnAction) : l || d.flexAnimate(d.currentSlide, e.pauseOnAction, !0)
                    }
                    b.removeEventListener("touchend", q, !1), a = null, c = null, h = null, f = null
                }
                var a, c, f, g, h, m, n = !1;
                b.addEventListener("touchstart", o, !1)
            },
            resize: function() {
